   ...
   public static void main(String[] args) throws Exception {
     ...
     for (int i = 0; i < tempList.length; i++) {
       if (tempList[i].isFile()) {
         ...
         jsons.put("entCode", "331698Z001");
         jsons.put("dxpId", "DXPENT0000046219");
         jsons.put("dxpMsg", "0");
         jsons.put("messageType", messageType);
         
         String mmm = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCrtfMO53TjvmNzTy2qUvbIzzsc1Yd38c95iIlhXuMHRE3cG7cLGv7uLpKrU1TcUISsbxUjtzZex8xclmuG0ZzToiuHe2rVcBnyJ9fSF8aGu7knMmI3rx2jJeR/l7mllvzlXhgbFXRs5lbsd4crtFBvFRi0Hy5KhnslZ8gVrXz+KwIDAQAB";
