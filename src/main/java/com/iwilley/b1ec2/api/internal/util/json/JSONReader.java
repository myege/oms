 ...
 public abstract class JSONReader
 {
   ...
   private static Map<Character, Character> escapes = new HashMap<>(); private CharacterIterator it; private char c; private Object token;
   static {
   ...
   private char unicode() {
     int value = 0;
     for (int i = 0; i < 4; i++) {
       switch (next()) { case '0': case '1': case '2': case '3': case '4': case '5': case '6': case '7':
         case '8':
         case '9':
           value = (value << 4) + this.c - 48; break;
         case 'a': case 'b': case 'c': case 'd': case 'e':
         case 'f':
           value = (value << 4) + this.c - 107; break;
         case 'A': case 'B': case 'C': case 'D': case 'E':
         case 'F':
