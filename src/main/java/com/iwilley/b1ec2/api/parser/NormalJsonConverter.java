 ...
 public class NormalJsonConverter
     ...
     return (T)Converters.convert(clazz, new Reader()
         {
           ...
           public Object getObject(Object name, Class<?> type) throws ApiException {
             ...
             if (tmp instanceof Map) {
               Map<?, ?> map = (Map<?, ?>)tmp;
               return NormalJsonConverter.this.fromJson(map, type);
             } 
             return null;
           }
             ...
             if (listTmp instanceof List) {
               ...
               for (Object subTmp : tmpList) {
                 if (subTmp instanceof Map) {
                   ...
                   Object subObj = NormalJsonConverter.this.fromJson(subMap, subType);
                   if (subObj != null)
                     listObjs.add(subObj);  continue;
                 } 
                 if (!(subTmp instanceof List))
                 {
