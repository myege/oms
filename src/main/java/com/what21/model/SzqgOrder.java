 ...
 public class SzqgOrder
 {
   ...
   public String getQdguid() {
     return this.qdguid;
   }
   
   public void setQdguid(String qdguid) {
     this.qdguid = qdguid;
   }
   ...
   public String getAbroadCo() {
     return this.abroadCo;
   }
   
   public void setAbroadCo(String abroadCo) {
     this.abroadCo = abroadCo;
   }
   
   public String getAbroadCoName() {
     return this.abroadCoName;
   }
   ...
   public String getConsigneePrvince() {
     return this.consigneePrvince;
   }
   
   public void setConsigneePrvince(String consigneePrvince) {
     this.consigneePrvince = consigneePrvince;
   }
