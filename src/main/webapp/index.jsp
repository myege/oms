...
<html lang="zh-cn">
 ...
 <body> 
  <header> 
   <div class="logo"> 
    <a href="index.html"><img src="${loginImg}" alt="曌通供应链曌通供应链曌通供应链曌通供应链曌通供应链" class="img-responsive ori" /></a> 
   </div> 
   <nav class="menu"> 
   ...
   <div class="hotline"> 
    <a href="tel:${hotline }" title="免费咨询热线"><span>${hotline }</span></a>
    <u></u> 
   </div> 
   <div class="menu-icon"> 
  ...
  <section class="contact"> 
   <div class="box"> 
    <div class="above"> 
     ...
     <div class="left"> 
      <a href="tel:${hotline }" title="网站咨询热线" class="tel"></a> 
      <p>${company }<u>&middot;</u>${city }<u></u>${park }<br />联系电话：${hotline2 }<br />地址：${address }<br />邮编：${zip }<a href="/job/saleman.html" target="_blank" class="job">[ 工作机会 ]</a></p> 
     </div> 
     <div class="right">
      Email：${Email }
      <br />中文域名：${domainName }
