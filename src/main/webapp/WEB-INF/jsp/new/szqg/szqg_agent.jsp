...
<!-- 								class="form-control" placeholder="结束时间" /></li> -->
			...
			<div class="btn-group-sm hidden-xs" id="toolbar" role="group">
				<!-- <a class="btn btn-success" id="add" onclick="$.operate.add('50%','50%')"> <i class="fa fa-plus"></i> 新2222增
				 ...
				 <a class="btn btn-warning" onclick="importAgent()"> <i class="fa fa-download"></i> 导入
				</a>
				<a style='color:blue' href='<%=path%>/xls/agent.xlsx'>下载企业备案模板</a>
...
<script type="text/javascript">
	...
	**/
	...
	function importAgent() {
		var openUrl = "<%=path%>/import/importAgent.jsp";//弹出窗口的url
		...
		if(length==0){
			...
			$.modal.confirm('确定要推送这<font color=red>'+rows.length+'条记录吗?',function(){
	       	//	layerMsg("删除中...");
						...
						$.post('<%=path%>/szqgament/toewtp.do',{ids:ids},
								function(ret){
