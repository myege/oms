...
<!-- 								id="search"><i class="fa fa-search"></i>&nbsp;搜索</a></li> -->
			...
			<div class="btn-group-sm" role="group">
				<button type="button" class="btn btn-success" style="margin-top: 10px;" id="add" onclick="auditOrder()"> <i class="fa fa-plus-square-o"></i> 
				审核
				</button>
				<!-- <button type="button" class="btn btn-success" style="margin-top: 10px;" id="add" onclick="pushOrder()"> <i class="fa fa-plus-square-o"></i> 
				推送网趣平台
				</button> -->
				<button type="button" class="btn btn-success" style="margin-top: 10px;" id="add" onclick="pushDd()"> <i class="fa fa-plus-square-o"></i> 
				订单申报
				</button>
				<button type="button" id="order_bonded_btn_2" style="margin-top: 10px;" class="btn btn-success" onclick="pushQd()">  <i class="fa fa-plus-square-o"></i> 
				清单申报
				</button>
				<button type="button" id="order_bonded_btn_3" style="margin-top: 10px;" class="btn btn-success" onclick="customs()">  <i class="fa fa-plus-square-o"></i> 
				运单申报
				</button>
				<!-- <button type="button" id="order_bonded_btn_4" style="margin-top: 10px;" class="btn btn-success" onclick="push3()">  <i class="fa fa-plus-square-o"></i> 
				推送3单
				</button> -->
				<button type="button" id="order_bonded_btn_5" style="margin-top: 10px;" class="btn btn-success" onclick="showPushCz()">  <i class="fa fa-plus-square-o"></i> 
				推送场站
				</button>
				<!-- <button type="button" id="order_bonded_btn_6" style="margin-top: 10px;" class="btn btn-success" onclick="showPushCzStatus()">  <i class="fa fa-plus-square-o"></i> 
				推送回执状态
				</button> -->
				<!-- <button type="button" id="order_bonded_btn_7" style="margin-top: 10px;" class="btn btn-success" onclick="deliverchange()">  <i class="fa fa-plus-square-o"></i> 
				推送换单
				</button> -->
				<!-- <button type="button" id="order_bonded_btn_8" style="margin-top: 10px;" class="btn btn-success" onclick="payNumber()">  <i class="fa fa-plus-square-o"></i> 
				匹配<font color=red>支付流水</font>号</a>
				</button> -->
				<!-- <button type="button" id="order_bonded_btn_9" style="margin-top: 10px;" class="btn btn-success" onclick="payNumberTL()">  <i class="fa fa-plus-square-o"></i> 
				匹配<font color=red>通联支付流水</font>号
				</button> -->
				<!-- <button type="button" id="order_bonded_btn_10" style="margin-top: 10px;" class="btn btn-success" onclick="payNumberYto()">  <i class="fa fa-plus-square-o"></i> 
				 匹配<font color=red>国际圆通订单</font>号</a>
				</button> -->
				<!-- <button type="button" id="order_bonded_btn_11" style="margin-top: 10px;" class="btn btn-success" onclick="helipay()">  <i class="fa fa-plus-square-o"></i> 
				合利宝
				</button>
				<button type="button" id="order_bonded_btn_12" style="margin-top: 10px;" class="btn btn-success" onclick="pushOrderToDsds()">  <i class="fa fa-plus-square-o"></i> 
				推送电商大师
				</button> -->
				
				<button type="button" id="order_bonded_btn_15" style="margin-top: 10px;" class="btn btn-danger" onclick="deleteOrderMail()"><i class="fa fa-remove"></i> 
				删除订单
				</button>
				
				<button type="button" id="order_bonded_btn_16" style="margin-top: 10px;" class="btn btn-success" onclick="UpdatetotalMailNo()"><i class="fa fa-download"></i> 
				提运单号修改
				</button>
				
				<c:if test='<%=userRole.contains("xsjl")%>'>
				<!-- <button type="button" id="order_bonded_btn_13" style="margin-top: 10px;" class="btn btn-success" onclick="pushBfb()">  <i class="fa fa-plus-square-o"></i> 
				江门<font color=red>邦付宝</font>
				</button> -->
					<button type="button" id="order_bonded_btn_13" style="margin-top: 10px;" class="btn btn-success" onclick="pushBfb2()">  <i class="fa fa-plus-square-o"></i> 
				<font color=red>联动</font>
				</button>
					<button type="button" id="order_bonded_btn_13" style="margin-top: 10px;" class="btn btn-success" onclick="pushldzfct()">  <i class="fa fa-plus-square-o"></i> 
				<font color=red>支付重推</font>
				</button>
				<!-- <button type="button" id="order_bonded_btn_14" style="margin-top: 10px;" class="btn btn-success" onclick="payNumberBfb()">  <i class="fa fa-plus-square-o"></i> 
				 匹配<font color=red>快付通流水</font>号
				</button> -->
				...
				<button type="button" id="order_bonded_btn_16" style="margin-top: 10px;" class="btn btn-success" onclick="outMailOrder_GD()"><i class="fa fa-download"></i> 
				导出(广东)
				</button>
				</c:if>
			</div>
...
//导出广东
function outMailOrder_GD(){
	layer.open({
	  	  title: '导出(广东)',
	  	  type: 2,
	  	  closeBtn: 2,
	  	  content: '<%=path%>/orderMail/outMailOrder_GDUI.do',
	  	  btn: ['导出', '取消'],
	  	  isOutAnim : true,
	  	  maxmin  : true,
	  	  anim : 2 ,
				...
				columns : [{field:'column',checkbox:true,align : 'center'},
                 ...
                 /*  	{field :'receiveProvince', title :'省',  align :'left'}, */
                  ...
                  /* 	{field :'itemName', title :'主要商品',  align :'left'}, */
					...
					{field :'isPushDd', title :'推送订单', align :'center',formatter:function(value){ 
							if(value == 0){
	                	   		return '未推送';
		                   	}else if(value == 1){
		                		return '已推送';
					...
					{field :'isCustoms', title :'推送运单',align :'center',formatter:function(value){ 
                  	...
                  	{field :'ispost', title :'推送平台', align :'center',formatter:function(value){ 
							if(value == 0){
	                	   		return '未推送';
		                   	}else if(value == 1){
		                		return '已推送';
