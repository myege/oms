...
<!-- 								id="search"><i class="fa fa-search"></i>&nbsp;搜索</a></li> -->
			...
			<div class="btn-group-sm" role="group">
				...
				<button type="button" class="btn btn-success" style="margin-top: 10px;" onclick="backOrder()"> <i class="fa fa-plus-square"></i> 
				回退审单
				</button>
			</div>
...
function backOrder(){
	...
	$.modal.confirm('确定要回退这<font color=red>'+rows.length+'条订单吗?',function(){
		layerMsg("回退中...");
		$.post('<%=path%>/orderBonded/backOrder.do',{ids:ids},
				function(ret){
...
function exportOrder(){
	layer.open({
	  	  ...
	  	  type: 2,
	  	  closeBtn: 2,
	  	  content: '<%=path%>/orderBonded/exportOrderUi.do',
	  	  btn: ['导出', '取消'],
	  	  isOutAnim : true,
	  	  maxmin  : true,
	  	  anim : 2 ,
